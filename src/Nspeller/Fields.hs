...
yearSpec = numberField "год" "year" "Год" "meta"
...
-- размеры, частоты и номера — неотрицательные с шагом 1, длительности
-- — неотрицательные без шага. Годы, средняя оценка, идентификатор
-- библиотеки и ReplayGain намеренно без границ: жёстких пределов у
-- них нет, и выдумывать их нельзя.
