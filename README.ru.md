...
**Язык:** веб-интерфейс Muzlovar и DSL Nspeller `.mix` доступны на русском и английском. Язык интерфейса выбирается в шапке, язык DSL — отдельно в предпросмотре `.mix`; явный выбор сохраняется локально в браузере. Оба варианта DSL дают одинаковый `.nsp`, а старые русские рецепты продолжают работать. Ниже показан русский интерфейс.
...
Nspeller преобразует русские и английские правила `.mix` в `.nsp` JSON для Navidrome. Файлы сохраняются в UTF-8 и допускают комментарии после `#`. Язык интерфейса и язык DSL выбираются независимо.
...
Русская грамматика, таблицы полей, операторы, ограничения и примеры описаны в [русском справочнике Nspeller](docs/nspeller-reference.ru.md); английский синтаксис — в [английском справочнике](docs/nspeller-reference.en.md). Готовые пары `.mix`/`.nsp` находятся в каталоге [`examples/`](examples/).
...
- DSL Nspeller поддерживает русский и английский синтаксис. Диагностические сообщения сервера пока остаются русскоязычными; неизвестные сообщения показываются без изменений.
