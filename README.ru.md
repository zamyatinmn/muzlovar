...
**Язык:** веб-интерфейс Muzlovar доступен на русском и английском. Язык выбирается в шапке интерфейса и сохраняется локально в браузере. Синтаксис DSL Nspeller остаётся русскоязычным. Ниже показан русский интерфейс.
...
- Синтаксис DSL Nspeller и диагностические сообщения сервера остаются русскоязычными. Интерфейс Muzlovar локализован на русский и английский; неизвестные сообщения сервера показываются без изменений.
